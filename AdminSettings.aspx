<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSettings.aspx.cs" Inherits="SOMS.AdminSettings" %>
...
<%--                <li class="nav-item me-5">
        ...
        <div class="container">
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    <div class="input-group mb-3">
                        <span class="input-group-text spanCustom"><i class="fa fa-users" style="color: #8faadc"></i></span>
                        <asp:Button runat="server" ID="btnManageGroups" CssClass="form-control" Text="Show Manage Groups Access Key" OnClick="btnManageGroups_Click"/>
                    </div>
                </div>
            ...
            <div class="info-container" style="display: flex;">
                <div style="flex: 1;">
                    <div class="input-group mb-3">
                        ...
                        <asp:Button runat="server" ID="btnDeleteAdminAcc" CssClass="form-control" Text="Delete this Admin Account" OnClick="btnDeleteAdminAcc_Click"/>
                    </div>
                </div>
                ...
                <div style="flex: 2; margin-left: 20px; text-align: justify;">
                    <p>
                        Deletion of this Admin account terminates all of the data registered
                        <br>
