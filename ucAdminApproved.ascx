<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAdminApproved.ascx.cs" Inherits="SOMS.WebUserControl1" %>
...
onclick='<%# "openEventModalApproved(\"" + Eval("ReferenceNo") + "\", \"" + Eval("Organization") + "\", \"" + Eval("Venue") + "\", \"" + Convert.ToDateTime(Eval("TimeStart")).ToString("yyyy-MM-dd") + "\", \"" + Eval("TimeEnd") + "\")" %>'>
