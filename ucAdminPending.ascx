<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAdminPending.ascx.cs" Inherits="SOMS.ucAdminPending" %>
...
onclick='<%# "openEventModalPending(\"" + Eval("ReferenceNo") + "\", \"" + Eval("Organization") + "\", \"" + Eval("Venue") + "\", \"" + Convert.ToDateTime(Eval("TimeStart")).ToString("yyyy-MM-dd") + "\", \"" + Eval("TimeEnd") + "\")" %>'>
    ...
    <div class="left-side">
        ...
        <div class="month-button">
            <asp:LinkButton ID="btnComment" runat="server"
                OnClientClick='<%# "event.stopPropagation(); openCommentModalPending(\"" + Eval("ReferenceNo") + "\"); return false;" %>'>
    ...
    <div class="right-side">
        <div class="organization">
            ...
            <asp:LinkButton ID="btnEditOrg" runat="server"
                OnClientClick='<%# "event.stopPropagation(); openEditModalPending(\"" + Eval("ReferenceNo") + "\"); return false;" %>'>
