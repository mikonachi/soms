<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SOAccessCode.aspx.cs" Inherits="SOMS.SOAccessCode" %>
...
<head>
    ...
    <link href="Content/AccessCode.css" rel="stylesheet" />
...
<%--                <li class="nav-item me-5">
                    <asp:LinkButton ID="btnLogIn" runat="server" CssClass="nav-button-login" Text="Log-In" />
                </li>--%>
            </ul>
        </div>
    </div>
        ...
        <div class="modal-overlay" id="modalOverlay">
            <div class="custom-message">
                ...
                <div class="message-footer">
                    <asp:Button ID="btnLogout" runat="server" Text="Log-out" CssClass="form-control btnAccLogOut" OnClick="btnLogout_Click"/>
