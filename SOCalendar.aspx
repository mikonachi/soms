<%@ Page Title="SOCalendar" Language="C#" AutoEventWireup="true" CodeBehind="SOCalendar.aspx.cs" Inherits="SOMS.SOCalendar" %>
        ...
        <div class="row" style="margin-left: 70px; margin-right: 0">
            <div class="col-12 col-md-3">
                <div class="container" style="margin-top: 30px;">
                    ...
                    <div class="text-center">
                        <br>
                        <asp:LinkButton ID="btnValiDate" runat="server" CssClass="btn btn-primary confirmBtn" OnClientClick="valiDate(); return false;"><i class="fas fa-calendar-check"></i> Vali-Date
                        </asp:LinkButton>
                        
                        <br>
                        <br>
                        <h6>Unsure of your date? Check availability fast <br> and find the perfect time or resources.</h6>
                ...
                <div class="modal-content" style="border-radius: 20px; border: none; padding: 20px;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer d-flex justify-content-between mt-3" style="border-top: none;">
                            ...
                            <asp:Button ID="btnCheck" runat="server" Text="Check" CssClass="btn btn-primary confirmBtn" OnClick="btnCheck_Click" />
                        </div>
                    </div>
                </div>
            </div>
