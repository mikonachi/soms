<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUpFaculty.aspx.cs" Inherits="SOMS.SignUpFaculty" %>
...
<body>
    <div class="container">
        <h1 class="page-title">Create an Account as Faculty Member</h1>
            ...
            <div class="section personal-info">
                <div class="left-column">
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="role" runat="server" CssClass="form-control" OnSelectedIndexChanged="role_SelectedIndexChanged" AutoPostBack="true" required="required">
                            <asp:ListItem Value="FAC">FACULTY MEMBER</asp:ListItem>
                            <asp:ListItem Value="ADM">ADMINISTRATOR</asp:ListItem>

                        </asp:DropDownList>
                    </div>
                    <div class="form-group">
                        <label for="student-number">ID Number</label>
                    ...
                    <div class="form-group">
                        <label for="organization">Specific Role</label>
