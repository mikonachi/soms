<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAdminRevDis.ascx.cs" Inherits="SOMS.ucAdminRevDis" %>
...
onclick='<%# "openEventModalRevDis(\"" + Eval("ReferenceNo") + "\", \"" + Eval("Organization") + "\", \"" + Eval("Venue") + "\", \"" + Convert.ToDateTime(Eval("TimeStart")).ToString("yyyy-MM-dd") + "\", \"" + Eval("TimeEnd") + "\")" %>'>
