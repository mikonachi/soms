...
namespace SOMS
{
    public partial class FacultyProposalTracking : System.Web.UI.Page
    {
        private readonly string connectionString = ConfigurationManager.ConnectionStrings["OMSDB"].ConnectionString;
        protected TextBox txtProposalDateFaculty;
        protected TextBox txtCommentFaculty;
        ...
        protected void btnSaveEvent_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, conn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ReceivedDate", Convert.ToDateTime(txtProposalDateFaculty.Text));
        ...
        protected void btnCommentSend_Click(object sender, EventArgs e)
        {
            ...
            SqlParameter[] parameters =
            {
                ...
                new SqlParameter("@comment", txtCommentFaculty.Text),
            ...
            try
            {
                ...
                if (rowsAffected > 0)
                {
                    ...
                    txtCommentFaculty.Text = string.Empty;
                }
                else
                {
