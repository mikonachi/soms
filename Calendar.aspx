<%@ Page Title="Calendar" Language="C#" AutoEventWireup="true" CodeBehind="Calendar.aspx.cs" Inherits="SOMS.Calendar" %>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto d-flex flex-row align-items-center">
                        ...
                        <li class="nav-item me-5">
                            <asp:LinkButton ID="btnProposalTracking" runat="server" CssClass="nav-button" Text="Proposal Tracking" OnClick="btnProposalTracking_Click1"/>
                        </li>
                        <li class="nav-item me-5">
